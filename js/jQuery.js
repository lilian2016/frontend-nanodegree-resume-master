        ...
        var doHover = function(itemList, itemHeader, listHeight) {
            ...
            if (false === oldList.is(":animated")) {
                ...
                if (itemHeader.hasClass(options.classOpen) === false) {
                    ...
                    itemHeader.addClass(options.classOpen).removeClass(options.classClosed);
                    oldList.closest("li").removeClass(options.classActive).find("a:first").addClass(options.classClosed).removeClass(options.classOpen)
                }
            }
        };
        var itemNo = 0;
